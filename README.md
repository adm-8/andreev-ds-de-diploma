...
* 1) Генерация данных, Обучение ML модели
* 2) Отправка кредитной заявки в Kafka (Opportunity Input Topic)
* 3) Чтение данных по кредитным заявкам из Kafka, применение модели из п.1 для получения предсказаний
* 4) Отправка результатов в Kafka (Opportunity Output Topic)
* 5) Складирование результатов в Parquet файл 
